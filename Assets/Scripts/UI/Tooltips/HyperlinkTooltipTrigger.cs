...
public class HyperlinkTooltipTrigger : MonoBehaviour  //IPointerClickHandler 
{
    [SerializeField] private TextMeshProUGUI pTextMeshPro;
    private Canvas pCanvas;
    private Camera pCamera;
    private int pCurrentLink = -1;

    // OLD CODE
    // private bool isLinkHighlighted { get { return pCurrentLink != -1; } }
    // private List<Color32[]> pOriginalVertexColors = new List<Color32[]>();
    // private bool doesColorChangeOnHover = true;
    // private Color hoverColor = new Color(60f / 255f, 120f / 255f, 1f);
    ...
    private void LateUpdate() {
        ...
        if(linkIndex != -1 && linkIndex != pCurrentLink ) {
            ...
            if (linkText.Length != 0) {
                TextTooltipUI.instance.Show("", linkText);
                return;
            }
            ...
            string tooltip = GameManager.instance.dictionary[keyword];
            // Display results
            TextTooltipUI.instance.Show(keyword, tooltip);
        }
